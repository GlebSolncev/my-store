        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <div class="sidebar">
                        <form id="form-filter" action="{{ route('category.filter', ['category' => $category->slug]) }}">
                            <!-- Sidebar Electronics Categorie Start -->
                            <div class="electronics mb-40">
                                <h3 class="sidebar-title">{{ $category->title }}</h3>
                                @if($childs = $category->childs)
                                    <div id="shop-cate-toggle" class="category-menu sidebar-menu sidbar-style">
                                        <ul>
                                            @foreach($childs as $child)
                                                @if($child->products()->count() > 1)
                                                    <li {{ $child->childs()->exists() ? 'class="has-sub"' : null }}>
                                                        ...
                                                        @if($c = $child->childs)
                                                            <ul class="category-sub">
                                                                @foreach($c as $item)
                                                                    <li>
                                                                        <a href="{{ route('category.index', ['category' => $item->slug]) }}">
                                                                            {{ $item->title }}
                                                                        </a>
                                                                    </li>
                                                                @endforeach
                            ...
                            @foreach($filters as $title => $filter)
                                <div class="sidebar-categorie mb-40">
                                    ...
                                    <ul class="sidbar-style">
                                        @foreach(collect($filter)->sortByDesc('count')->sortByDesc('checked') as $item)
                                            <li class="form-check">
                                                <input class="form-check-input"
                                                       name="filter[{{ $item['group_id'] ?? null }}][]"
                                                ...
                                                <label class="form-check-label" for="{{ $item['id'] ?? null }}">
                                                    {{ $item['title'] ?? null }}
                                                    ({{ $item['count'] }})
                                                </label>
                                            </li>
                                    ...
                                    @foreach($products as $product)
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="{{ \Illuminate\Support\Facades\Storage::disk('product')->url($product->content->image) }}" alt="single-product">
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        ...
                                                        <p><span class="price">{{ \App\Helper::formatPrice($product->price, true) }}</span><del class="prev-price">$400.50</del></p>
                                                        <div class="label-product l_sale">30<span class="symbol-percent">%</span></div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-12">
                                                <div class="pro-content hot-product2">
                                                    <h4><a href="product.html">{{ $product->name }}</a></h4>
                                                    <p><span class="price">{{ \App\Helper::formatPrice($product->price) }}</span></p>
